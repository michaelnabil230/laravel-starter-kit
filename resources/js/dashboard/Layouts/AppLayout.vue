...
<template>
    <App :title="title">
        ...
        <main :class="cn('h-full min-h-screen pt-14.75 lg:ms-65', props.class)">
        ...
        <footer
            class="relative inset-x-0 bottom-0 mt-5 h-10 border-t border-gray-200 bg-white sm:h-16 lg:ms-65 dark:border-neutral-700 dark:bg-neutral-900"
        >
            <p class="p-2 text-xs text-gray-500 sm:p-5 sm:text-sm dark:text-neutral-500">
                {{ initialSharedData('appName') }} © {{ __('all_rights_reserved') }}. {{ new Date().getFullYear() }}.
            </p>
        </footer>
    </App>
</template>
