                    ...
                    >
                        <div class="text-center">
                            ...
                            <div class="mt-4 flex flex-wrap justify-center text-sm leading-6 text-stone-600">
                                ...
                                <label
                                    for="file"
                                    class="focus-within:ring-cerulean-blue-700 relative cursor-pointer rounded-lg bg-white font-semibold text-blue-700 decoration-2 focus-within:ring-2 focus-within:ring-offset-2 focus-within:outline-hidden hover:text-blue-700 hover:underline dark:bg-neutral-800 dark:text-blue-500 dark:hover:text-blue-700"
                                >
                                    <span>{{ __('browse') }}</span>
