...
<template>
    <SelectRoot v-bind="forwarded">
        <SelectTrigger
            :class="
                cn(
                    'focus:ring-cerulean-blue-500 flex w-full cursor-pointer items-center justify-between gap-x-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-start text-sm text-nowrap focus:ring-2 focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-transparent dark:text-neutral-300 dark:focus:ring-1 dark:focus:ring-neutral-600 dark:focus:outline-hidden',
                    {
            ...
            >
                <div v-if="hasSearch" class="sticky top-0 -mx-1 bg-white p-2 dark:bg-neutral-900">
                    <input
                        ...
                        type="text"
                        class="focus:ring-cerulean-blue-500 block w-full rounded-lg border-gray-200 px-3 py-2 text-sm focus:border-blue-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder-neutral-500"
                    />
                </div>
