...
<template>
    <div class="relative">
        <textarea
            ...
            :class="
                cn(
                    'focus:ring-cerulean-blue-500 block w-full resize-none rounded-lg border-gray-200 px-3 py-2 text-sm placeholder:text-gray-400 focus:border-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-transparent dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600',
                    {
