...
onMounted(() => {
    ...
    const actions = [
        ...
        {
            id: '#hs-editor-tiptap [data-hs-editor-color]',
            onClick: () => document.getElementById('color-picker')?.click(),
        },
        {
            id: '#hs-editor-tiptap [data-hs-editor-undo]',
            onClick: () => editor.chain().focus().undo().run(),
        },
        {
            id: '#hs-editor-tiptap [data-hs-editor-redo]',
            onClick: () => editor.chain().focus().redo().run(),
        },
        {
            id: '#hs-editor-tiptap [data-hs-editor-left]',
            onClick: () => editor.chain().focus().setTextAlign('left').run(),
        },
        {
            id: '#hs-editor-tiptap [data-hs-editor-center]',
            onClick: () => editor.chain().focus().setTextAlign('center').run(),
        },
        {
            id: '#hs-editor-tiptap [data-hs-editor-right]',
