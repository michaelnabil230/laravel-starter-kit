...
<template>
    ...
    >
        <div id="editor-tiptap">
            ...
            >
                <button
                    class="focus:ring-cerulean-blue-500 inline-flex size-8 cursor-pointer items-center justify-center gap-x-2 rounded-full border border-transparent text-sm font-semibold text-gray-800 hover:bg-gray-100 focus:border-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:text-white dark:hover:bg-neutral-700 dark:focus:ring-neutral-600"
                    type="button"
                    data-editor-bold
                >
                    <svg
