...
<template>
    ...
    >
        <!-- User Profile Card -->
        <div
            class="px-5 py-3 rounded-xl border border-stone-200 bg-white shadow-2xs dark:border-neutral-700 dark:bg-neutral-800"
        >
            <div class="flex flex-col items-center md:items-start md:flex-row gap-3">
                <img class="object-cover size-30 rounded-xl" :src="user.profile_photo_url" alt="Avatar" />
                ...
                <div class="flex flex-col gap-1.5 w-full">
                    ...
                    <div class="grid md:grid-cols-4 gap-2">
                        <a
                            ...
                            class="inline-flex items-center gap-x-2 text-sm text-gray-500 dark:text-neutral-500 decoration-2 hover:underline focus:underline"
                        >
                            <svg
                        ...
                        <p class="inline-flex items-center gap-x-2 text-sm text-gray-500 dark:text-neutral-500">
                            ...
                            <svg
                                v-if="user.gender == Gender.FEMALE"
                                class="shrink-0 size-4"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                width="24"
