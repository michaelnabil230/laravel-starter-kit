...
const {
    ...
    confirmDeleteAll,
    resetDeletionState,
} = useItemSelectionManager('user', props.users.data, route('dashboard.users.pluck-destroy'), {
    onSuccess: () => {
...
const { confirmDelete, openDeleteModal, closeDeleteModal } = useDeletion<App.Models.User>(
    'user',
...
const { filters, updatePerPage } = useFilters(route('dashboard.users.index'), props.filters);
    ...
    <AppLayout :title="__('resources.user.plural')" :breadcrumbs="breadcrumbs">
        <div class="flex items-center justify-between gap-x-5">
            ...
            <div class="flex items-center justify-end gap-x-2">
                <!-- Button -->
                <Links.Solid.Primary :href="route('dashboard.users.create')">
                    <svg
                ...
                <div class="-m-1.5 overflow-x-auto">
                    <div class="inline-block min-w-full p-1.5 align-middle">
                        ...
                        >
                                            ...
                                            <div class="flex items-center justify-end -space-x-px">
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        ...
                                                        :aria-labelledby="'menu-item-' + user.id"
                                                    >
                                                        <div class="p-1">
                                                            <Link
                            ...
                            <!-- Footer -->
                            <Pagination :pagination="users" @per-page="updatePerPage" />
                            <!-- End Footer -->
                        </div>
                    </div>
                </div>
        ...
        <Delete resource="user" @close="closeDeleteModal" @confirm="confirmDelete" />

        <DeleteAll resource="user" @close="closeDeleteItemsModal" @confirm="confirmDeleteAll" />
    </AppLayout>
</template>
