...
onMounted(() => dashboardApp.addShortcut('mod+/', open));
...
<template>
    <Teleport defer to="#button-global-search-sm">
        <button
            @click="open"
            type="button"
            class="lg:hidden cursor-pointer inline-flex size-[38px] shrink-0 items-center justify-center gap-x-2 rounded-full text-gray-500 hover:bg-gray-100 focus:bg-gray-100 focus:outline-hidden dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
        >
            <svg
    ...
    <div class="hidden min-w-80 lg:block xl:w-full">
        <div class="relative">
            ...
            <input
                ...
                class="block w-full rounded-lg focus:outline-none focus:ring-0 border-gray-200 bg-white py-2 pe-16 ps-10 text-sm outline-hidden dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-400 dark:placeholder:text-neutral-400"
    ...
    <DialogRoot v-model:open="modal">
        <DialogPortal>
            <DialogOverlay
                class="z-60 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 bg-gray-900/50 dark:bg-neutral-900/80 backdrop-blur-md"
            />

            <DialogContent
                class="max-w-xl fixed top-1/2 left-1/2 -translate-1/2 z-100 w-full duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95"
            >
                <DialogTitle />
                <DialogDescription />
                ...
                >
                    ...
                    <div
                        class="overflow-hidden overflow-y-auto p-4 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar]:w-2"
                    >
