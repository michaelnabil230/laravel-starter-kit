...
const remove = () => {
    dashboardApp.remove(props.toast.id!);
};
</script>
        ...
        <div class="flex p-4">
            ...
            <div class="ms-3 flex w-full justify-between">
                ...
                <button
                    type="button"
                    @click="remove()"
                    class="cursor-pointer inline-flex size-5 shrink-0 items-center justify-center rounded-lg text-white opacity-50 hover:text-white hover:opacity-100 focus:opacity-100 focus:outline-hidden"
                    aria-label="Close"
                >
