...
import { ModalVariants, modalVariants } from '.';
    ...
    <DialogRoot v-model:open="modal">
        <DialogPortal>
            ...
            <DialogContent :class="modalVariants({ size })">
                <div
                    class="flex flex-col overflow-hidden w-full bg-white border border-gray-200 shadow-2xs pointer-events-auto rounded-xl dark:border-neutral-800 dark:bg-neutral-800"
                >
                    <slot />
                </div>
            </DialogContent>
