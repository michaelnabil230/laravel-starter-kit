...
<template>
    ...
    <aside
        :data-state="modal ? 'open' : 'closed'"
        class="rtl:translate-x-full ltr:-translate-x-full data-[state=open]:translate-x-0 transition-all duration-300 transform w-65 h-full fixed inset-y-0 start-0 z-60 bg-white border-e border-gray-200 lg:block lg:translate-x-0 rtl:lg:translate-x-0 ltr:lg:-translate-x-0 lg:end-auto lg:bottom-0 dark:bg-neutral-800 dark:border-neutral-700"
    >
        <div class="flex h-full max-h-full flex-col py-3">
            ...
            <div
                class="mt-1.5 h-full overflow-y-auto [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 [&::-webkit-scrollbar-track]:bg-gray-100 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 [&::-webkit-scrollbar]:w-2"
            >
            ...
            <div
                :data-state="modal ? 'open' : 'closed'"
                class="absolute -end-3 top-3 z-10 lg:hidden data-[state=closed]:hidden"
            >
                <button
                    @click="close"
                    type="button"
                    class="cursor-pointer inline-flex h-7 w-6 items-center justify-center gap-x-2 rounded-md border border-gray-200 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:bg-gray-100 focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                >
                    <svg
                        class="size-4 shrink-0"
                        xmlns="http://www.w3.org/2000/svg"
