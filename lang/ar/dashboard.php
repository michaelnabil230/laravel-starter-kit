...
return [
    ...
    'authentication' => [
        ...
        'register' => [
            ...
            'description' => 'الوصول إلى المنتجات الرقمية عبر :appName.',
            'attributes' => [
                'organization_name' => 'اسم المنشأة',
                'max_employees' => 'الحد الأعلى للموظفين',
            ],
            'submit' => 'تسجيل',
        ],
    ...
    'global' => [
        ...
        'enums' => [
            ...
            'attendance_methods' => [
                'face_rekognition' => 'التعرف على الوجه',
                'code' => 'كود',
            ],
            'employment_types' => [
                'full_time' => 'وقت كامل',
    ...
    'import' => [
        ...
        'model' => [
            ...
            'drag_drop' => 'اسحب وأسقط الملفات هنا أو',
            'extensions' => 'CSV, XLS, DOCX',
